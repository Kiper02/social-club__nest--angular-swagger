...
export class AuthController {
  ...
  @ApiResponse({
    ...
    schema: {
      type: 'string',
      example:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6IjEyc3NzYTMiLCJpZCI6OSwiaWF0IjoxNzI4MDQ4Mzk1LCJleHAiOjE3MjgxMzQ3OTV9.2uit3I4K-b1Dmws5X8YfvYNOjJz1tkXVyTz0fyPZ44g',
    },
  })
