...
@Component({
  ...
  standalone: true,
  imports: [HeaderComponent, NavProfileComponent, RouterModule, ChatModalComponent, CommonModule],
...
export class ProfileComponent implements OnInit {
  ...
  getChats() {
    this.chatService.getAllbyUserId(this.id).subscribe((data: IResponseChat[]) => {
      this.chats = data;
